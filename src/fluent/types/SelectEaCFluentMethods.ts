...
> = K extends "Details" ? EaCDetailsFluentMethods<T, K, TEaC>
  : HasDetailsProperty<T> extends true
    ? IsObject<T[K]> extends true ? SelectEaCValueTypeMethods<T, K, TEaC>
    : EaCPropertyFluentMethods<T, K, TEaC>
  : IsObject<T[K]> extends true ? EaCObjectFluentMethods<T, K, TEaC>
  : EaCPropertyFluentMethods<T, K, TEaC>;
